...
| [SPEC-058](./SPEC-058-design-system.md) | デザインシステム & デザイン憲章（カラー・タイポ・コンポーネントトークン・16原則） | Active | `prototype/styles.css`（全体）/ `prototype/index.html`（全画面）/ `docs/screens/SCREEN-DESIGN.md` | 2026-04-26 |
