...
| [SPEC-058](./SPEC-058-ui-design-prototypes.md) | UI デザインプロトタイプ比較（絵本寄り / ゲーム HUD 寄り + 今日の焦点カード + きろく導線） | Active | `prototype/index.html` #design-style-switch, #today-focus-card, #screen-record / `prototype/game.js` applyDesignPrototype, renderTodayFocusCard, renderRecordScreen / `prototype/styles.css` .theme-picturebook, .theme-gamehud, .today-focus-*, .record-* | 2026-04-26 |
