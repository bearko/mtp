...
| [SPEC-060](./SPEC-060-css-svg-juice.md) | CSS/SVG 演出強化（素材なしフォールバック） | Active | `prototype/index.html` #play-scene-stage / `prototype/game.js` renderPlaySceneStage, playSceneConfigForPlay / `prototype/styles.css` .play-scene-* | 2026-04-27 |
